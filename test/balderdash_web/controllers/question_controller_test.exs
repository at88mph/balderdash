defmodule BalderdashWeb.QuestionControllerTest do
  use BalderdashWeb.ConnCase

  alias Balderdash.Questions

  @create_attrs %{answer: "some answer", incorrect_four: "some incorrect_four", incorrect_one: "some incorrect_one", incorrect_three: "some incorrect_three", incorrect_two: "some incorrect_two", text: "some text"}
